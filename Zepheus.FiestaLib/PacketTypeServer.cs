...
namespace Zepheus.FiestaLib
{
    ...
    {
        PartyRequestFromCharacter = 3,

        PartyInviteAnswer = 7,
        PartyCharacterList = 9,
        LeaveParty = 11,
        PartyInformationShort = 50,
        PartyInformation = 51,
        PartyMemberLogin = 61,
        PartyLoginCord = 73,
        PartyMatchingSystem = 85,
        PartyInvite = 95
    }
    ...
    {
        LoadQuickBar = 3, //Get 7
        LoadQuickBarState = 5, //Get 8
        LoadGameSettings = 11, //
