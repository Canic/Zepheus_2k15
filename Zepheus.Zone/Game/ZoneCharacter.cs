...
namespace Zepheus.Zone.Game
{
    public sealed class ZoneCharacter : MapObject
    {
        ...
        public override uint MaxLP { get { return (uint)(100); } set { return; } }
        ...
        public ZoneCharacter(string name, bool loadequips = true)
        {
            try
            {
                ...
                Program.Entity.Refresh(System.Data.Entity.Core.Objects.RefreshMode.StoreWins, character); //fixes changes when character is offline
        ...
        public void SendGetIngameChunk()
        {
            ...
            Handler4.SendPremiumItemList(this); //TEST
        ...
        public void HealHP(uint value)
        {
            ...
            Handler9.SendUpdateHP(this);
            Handler14.SendPartyMemberHPSPLP(this);
        }
        ...
        public void HealLP(uint value)
        {
            ...
            Handler9.SendUpdateLP(this);
            Handler14.SendPartyMemberHPSPLP(this);
        }

        public void SetLP(uint value)
        {
            if (value > MaxLP) value = MaxLP;
            if (value < 0) value = 0;
            LP = value;
            Handler9.SendUpdateLP(this);
            Handler14.SendPartyMemberHPSPLP(this);
        ...
        public void BuyHPStones(Packet packet, Packet ppacket, short amount)
        {
            this.StonesHP += amount;
            this.Money -= (DataProvider.Instance.GetBaseStats(this.Job, this.Level).PriceHPStone * amount);

            packet.WriteShort(this.StonesHP);
