...
namespace Zepheus.Zone
{
    ...
    public sealed class CommandHandler
    {
        ...
        public void LoadCommands()
        {
            ...
            RegisterCommand("&killallmob", KillAllMobs, 1);
        ...
        {
            int lvls = param.Length >= 2 ? int.Parse(param[1]) : (int)1;
            character.Level = ((byte)(lvls - 1));
            character.LevelUP();
        }
